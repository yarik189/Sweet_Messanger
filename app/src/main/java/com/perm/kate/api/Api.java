...
public class Api {
    ...
    public ArrayList<User> getFriends(Long user_id, String fields, String order, Integer lid, String captcha_key, String captcha_sid) throws IOException, JSONException, KException {
